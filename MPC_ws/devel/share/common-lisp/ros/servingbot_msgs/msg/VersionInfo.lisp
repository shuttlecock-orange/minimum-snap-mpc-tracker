...
(cl:defmethod cl:initialize-instance :after ((m <VersionInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VersionInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name servingbot_msgs-msg:<VersionInfo> is deprecated: use servingbot_msgs-msg:VersionInfo instead.")))

(cl:ensure-generic-function 'hardware-val :lambda-list '(m))
(cl:defmethod hardware-val ((m <VersionInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servingbot_msgs-msg:hardware-val is deprecated.  Use servingbot_msgs-msg:hardware instead.")
  (hardware m))

(cl:ensure-generic-function 'firmware-val :lambda-list '(m))
(cl:defmethod firmware-val ((m <VersionInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servingbot_msgs-msg:firmware-val is deprecated.  Use servingbot_msgs-msg:firmware instead.")
  (firmware m))

(cl:ensure-generic-function 'software-val :lambda-list '(m))
(cl:defmethod software-val ((m <VersionInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servingbot_msgs-msg:software-val is deprecated.  Use servingbot_msgs-msg:software instead.")
  (software m))
